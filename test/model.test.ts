...
import casbin, { Enforcer } from '../src/casbin';
...
test('TestBasicModelWithRoot', async () => {
  const e = await casbin.newEnforcer('examples/basic_with_root_model.conf', 'examples/basic_policy.csv');
...
test('TestBasicModelWithRootNoPolicy', async () => {
  const e = await casbin.newEnforcer('examples/basic_with_root_model.conf');
...
test('TestBasicModelWithoutUsers', async () => {
  const e = await casbin.newEnforcer('examples/basic_without_users_model.conf', 'examples/basic_without_users_policy.csv');
...
test('TestBasicModelWithoutResources', async () => {
  const e = await casbin.newEnforcer('examples/basic_without_resources_model.conf', 'examples/basic_without_resources_policy.csv');
  await e.initialize();
...
test('TestRBACModelWithResourceRoles', async () => {
  const e = await casbin.newEnforcer('examples/rbac_with_resource_roles_model.conf', 'examples/rbac_with_resource_roles_policy.csv');
...
test('TestRBACModelWithDomains', async () => {
  const e = await casbin.newEnforcer('examples/rbac_with_domains_model.conf', 'examples/rbac_with_domains_policy.csv');
...
test('TestABACModel', async () => {
  const e = await casbin.newEnforcer('examples/abac_model.conf');
...
test('TestKeyMatchModel', async () => {
  const e = await casbin.newEnforcer('examples/keymatch_model.conf', 'examples/keymatch_policy.csv');
...
test('TestKeyMatch2Model', async () => {
  const e = await casbin.newEnforcer('examples/keymatch2_model.conf', 'examples/keymatch2_policy.csv');
...
test('TestKeyMatchCustomModel', async () => {
  const e = await casbin.newEnforcer('examples/keymatch_custom_model.conf', 'examples/keymatch2_policy.csv');
...
test('TestIPMatchModel', async () => {
  const e = await casbin.newEnforcer('examples/ipmatch_model.conf', 'examples/ipmatch_policy.csv');
...
test('TestPriorityModel', async () => {
  const e = await casbin.newEnforcer('examples/priority_model.conf', 'examples/priority_policy.csv');
...
test('TestPriorityModelIndeterminate', async () => {
  const e = await casbin.newEnforcer('examples/priority_model.conf', 'examples/priority_indeterminate_policy.csv');
