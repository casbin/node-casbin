...
export class Config implements ConfigInterface {
  ...
  /**
   * newConfigFromString create an empty configuration representation from string.
   *
   * @param text the model string.
   * @return the constructor of Config.
   */
  public static newConfigFromString(text: string): Config {
