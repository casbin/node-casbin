...
/**
 * newSyncedEnforcer creates a synchronized enforcer via the model and adapter instance.
 * @param model {Model} instance.
 * @param adapter {Adapter} instance.
 * @param enableLog controls whether logger is enabled.
 */
export async function newSyncedEnforcer(model: Model, adapter?: Adapter, enableLog = true): Promise<SyncedEnforcer> {
