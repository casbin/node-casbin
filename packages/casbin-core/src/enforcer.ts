...
/**
 * newEnforcer creates an enforcer via the model and adapter instance.
 * @param model {Model} instance.
 * @param adapter {Adapter} instance.
 * @param enableLog controls whether logger is enabled.
 */
export async function newEnforcer(model?: Model, adapter?: Adapter, enableLog = true): Promise<Enforcer> {
