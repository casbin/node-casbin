...
export class CachedEnforcer extends Enforcer {
  ...
  // setEnableCache determines whether to enable cache on enforce(). When enableCache is enabled, cached result (true | false) will be returned for previous decisions.
...
/**
 * newCachedEnforcer creates a cached enforcer via the model and adapter instance.
 * @param model {Model} instance.
 * @param adapter {Adapter} instance.
 * @param enableLog controls whether logger is enabled.
 */
export async function newCachedEnforcer(model: Model, adapter?: Adapter, enableLog = true): Promise<CachedEnforcer> {
