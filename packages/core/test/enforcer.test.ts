...
import { Model, Enforcer, StringAdapter, Util, newModelFromString } from '../src';
import { FileAdapter, newEnforcer } from './enforcerHelper';
...
test('TestSavePolicy', async () => {
  ...
  expect(e.savePolicy()).rejects.toThrow('not implemented');
});
