...
class Policy {
  ...
  public getFilteredPolicy(sec: string, ptype: string, fieldIndex: number, ...fieldValues: string[]): string[][] {
    return [];
  }
  ...
  public removeFilteredPolicy(sec: string, ptype: string, fieldIndex: number, ...fieldValues: string[]): boolean {
    return true;
  }

  public getValuesForFieldInPolicy(sec: string, ptype: string, fieldIndex: number): string[] {
    return [];
  }
}
